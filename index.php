...
The purpose of this project is to complete one code project daily for the remainder of the month of February.  This will be from February 3 to February 28.<br><br>

<center><table border="1" cellpadding="2" cellspacing="0"><tr><th colspan="7">Technologies Used (26 Days)</th></tr>
<tr><td><a href="jsCode.php">JavaScript<br>(w/o AJAX)</a></td><td><a href="jsAjaxCode.php">JavaScript<br>(w AJAX)</a></td><td><a href="phpCode.php">PHP</a></td><td><a href="mysqlCode.php">mySQL</a></td><td><a href="perlCode.php">PERL</a></td><td><a href="javaCode.php">Java</a></td><td><a href="cCode.php">C</a></td></tr>
<tr><td>6</td><td>3</td><td>12</td><td>3</td><td>4</td><td>7</td><td>2</td></tr></table>
<br><a href="amusements.php">Amusements</a> | <a href="utilities.php">Utilities</a></center><br>
...
<a href="feb13/">February 13</a> - Numerical Evaluator - Uses PERL - Parses a mathematical expression containing numerical values, +-*/, and parentheses.  Displays the steps taken in order to evaluate the expression, and prints the result. <br><br>
...
<a href="feb15/">February 15</a> - Neural Networker - Uses C - The C program can either construct a random neural network of arbitrary size or load one from a file, and conduct learning on that.  This is implemented with a web interface on the specific function (x*Input1+y*Input2+1)/(2+x+y), with X and Y user inputs.  The program will do up to 25000 training cycles with randomly generated inputs, with a "score" being displayed at different levels. <br><br>
...
<a href="feb20/">February 20</a> - CAPTCHA Generator - Uses PHP - Type your text into the box, and a CAPTCHA based on that text will be generated.  The CAPTCHA uses several anti-OCR techniques including variable placement of characters, variable color of characters, random rows of pixels being shifted horizontally, random rows of pixels being inverted, and random rows of pixels being erased.<br><br>
...
<a href="feb26/">February 26</a> - Random Data Generator - Uses PHP - Generates a CSV list containing random integers, decimals, or character strings of type selected by the user.<br><br>
